...
def run(args):
    ...
    class cfg:
        ...
        f_corr_thresh = args.corr_thresh # threshold to penalize the correlation
        f_add_thresh = args.corr_thresh # threshold to add new exprs to the zoo
        f_score_thresh = args.ic_thresh # threshold to filter exprs in the zoo
        f_multi_score_thresh = {'icir':args.icir_thresh}
    ...
    print(f"seed:{args.seed},name:{cfg.name}")
